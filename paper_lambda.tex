...
% =====================================================================
% TABLE II: INTERNAL CONSISTENCY BENCHMARKS (APS/PRD STYLE)
% =====================================================================
\begin{table*}[t]
...
4. Limit $r \to 0$ & Core saturation & Finite $P$ (Eq.~\eqref{eq:core_differential}) & \text{Pass} \\
5. Binary / GW & LIGO Speed & $v_{\text{gw}} = c$ ($\Delta = 0.00$) & \text{Pass} \\
6. Galactic Center & S2 Orbit Offset & $\delta \theta \approx 0.101\text{ mas}$ & \text{Pass} \\
