...
Using $H_0 = 67.4~\mathrm{km~s^{-1}~Mpc^{-1}}$, $a_0 = 1.20 \times 
10^{-10}~\mathrm{m/s^2}$, and $\Omega_\Lambda = 0.688$ \cite{Planck2018}, 
Eq.~\eqref{eq:rho_bd_definition} gives
\begin{equation}
...
% -------------------------------------------------------------
\begin{table*}[t]
\caption{Internal consistency benchmarks (not independent 
falsification). See Sec.~VI\,A.}
...
\hline
1. Solar Field & Perihelion & $42.98''/\mathrm{cy}$ 
($\Delta = 0.005\%$) & Pass \\
2. Galactic ($a_0$) & SPARC Curves & Flat $199.77~\mathrm{km/s}$ 
($15$--$50\,\mathrm{kpc}$) & Pass \\
3. Strong Field & Sirius B & $77.05~\mathrm{km/s}$ 
($\Delta = 4.17\%$) \cite{Bond2017} & Pass \\
4. Limit $r \to 0$ & Core saturation & Finite $P$ 
(Eq.~\eqref{eq:P_sat}) & Pass \\
5. Binary / GW & LIGO Speed & $v_{\rm gw} = c$ 
($\Delta = 0.00$) & Pass \\
\hline\hline
\end{tabular}
\end{table*}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.75\textheight]{fig3_singularidad.pdf}
